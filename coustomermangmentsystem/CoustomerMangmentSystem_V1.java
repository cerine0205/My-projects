...
public class CoustomerMangmentSystem_V1 {
...
//--------------------------ADDING TO THE ARRAY-------------------------------------
       //-----------------if choice was 'a'------------------------------
        if(choice == 'a')
        {
            ...
            System.out.printf("\n***************************************************\n"
              +"%s (ID #%d) has been added to the system.\n"
        ...
        else if(choice == 'd')
        {
            ...
            {
                System.out.println("\nnothing added yet!!\n"
                        + "<< you have to add the coustomer first. >>");
                continue;
            }
...
//     --------------------SWITCH------------------------
 ...
 //     --------------------END SWITCH------------------------
    ...
    public static String city(String msg)
    {
        ...
        if(city.equalsIgnoreCase("Thuwal"))
        {
            System.out.println("\n!! Thuwal is out of service !!\n"
                    + "please try again.\n");
            continue;
        }
